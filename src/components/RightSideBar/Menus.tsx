    ...
    return (
        <div className="flex items-center gap-5 pe-5">
            <div className="dropdown relative inline-flex [--auto-close:inside] [--offset:8] [--placement:bottom-end]">
                ...
                <div className="dropdown-menu overflow-y-auto dropdown-open:opacity-100 hidden bg-white drop-shadow-2xl" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-scrollable">
            ...
            <div className="dropdown relative inline-flex [--auto-close:inside] [--offset:8] [--placement:bottom-end]">
                ...
                <ul className="dropdown-menu bg-white drop-shadow-2xl dropdown-open:opacity-100 hidden min-w-60" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-avatar">
